...
caching, and response post-processing.
"""
...
from ..ai_emotion.mock_responses import get_mock_response
from ..ai_emotion.poetic_responses import should_trigger_poetic_circuit, get_poetic_response
from ..ai_logic.context_detection import detect_who_elsie_addressed
from ..ai_coordinator.conversation_utils import convert_to_third_person_emotes, strip_discord_emojis
from ..handlers_utils import filter_meeting_info, convert_earth_date_to_star_trek


class AIEngine:
    """
    AI Engine for response generation with proper instance state management.
    """
    ...
    def __init__(self):
        """Initialize the AI Engine with instance state."""
        self.response_cache = {}  # Instance-level cache instead of global
        print("✓ AIEngine initialized with instance-level caching")
...
"""
    ...
    def _should_use_chunking(self, content: str) -> bool:
        ...
        return estimated_tokens > self.MAX_OUTPUT_TOKENS * 0.8  # Use 80% threshold for safety
